...
class SBPLLatticePlanner : public path_planner::BasePathPlanner {
public:
   ...
   */
  SBPLLatticePlanner(std::string name, costmap_2d::Costmap2D* costmap, costmap_2d::Costmap2DROS* costmap_ros);
  ...
  virtual void initialize(std::string name, 
                          costmap_2d::Costmap2D* costmap, costmap_2d::Costmap2DROS* costmap_ros);
...
//                    const geometry_msgs::PoseStamped& goal);
  ...
  costmap_2d::Costmap2D* costmap_; /**< manages the cost map for us */
